...
def main():
    ...
    for i in dir_list:
        ...
        for img in listing:
                ...
                #img = cv.imread('/mnt/data/haahm/Final_execution/training/image_2/025_baseline_0.3_extr_816.png')
                #img = cv.imread('/mnt/data/haahm/Finalising_everything/training/image_2/021_baseline_0.3_extr_74.png')
                ...
                for cnt in contours:
                    ...
                    if (area>largest_area):
                        ...
                        #bounding_rect=cv.boundingRect(contours[cnt])
                # rect=img(contours[cnt]).clone()
                # cv.imshow('largest contour ',rect)
...
if __name__ == '__main__':
    ...
    # parser.add_argument('--outputPath', default='/mnt/data/haahm/Final_execution/',
    #                     help='outputPath')
